...
func NewTrialPlTwoYearsResponseTrialPlTwoYears(companyId int32, balances []TrialPlTwoYearsResponseTrialPlTwoYearsBalances, ) *TrialPlTwoYearsResponseTrialPlTwoYears {
	this := TrialPlTwoYearsResponseTrialPlTwoYears{}
...
func (o *TrialPlTwoYearsResponseTrialPlTwoYears) GetBalances() []TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
	if o == nil  {
		var ret []TrialPlTwoYearsResponseTrialPlTwoYearsBalances
		return ret
	}
...
func (o TrialPlTwoYearsResponseTrialPlTwoYears) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlTwoYearsResponseTrialPlTwoYears struct {
	value *TrialPlTwoYearsResponseTrialPlTwoYears
	isSet bool
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYears) Get() *TrialPlTwoYearsResponseTrialPlTwoYears {
	return v.value
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYears) Set(val *TrialPlTwoYearsResponseTrialPlTwoYears) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYears) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYears) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlTwoYearsResponseTrialPlTwoYears(val *TrialPlTwoYearsResponseTrialPlTwoYears) *NullableTrialPlTwoYearsResponseTrialPlTwoYears {
	return &NullableTrialPlTwoYearsResponseTrialPlTwoYears{value: val, isSet: true}
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYears) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYears) UnmarshalJSON(src []byte) error {
	v.isSet = true
