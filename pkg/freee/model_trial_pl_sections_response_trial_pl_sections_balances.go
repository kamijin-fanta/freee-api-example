...
func NewTrialPlSectionsResponseTrialPlSectionsBalances() *TrialPlSectionsResponseTrialPlSectionsBalances {
	this := TrialPlSectionsResponseTrialPlSectionsBalances{}
	return &this
}
...
func (o *TrialPlSectionsResponseTrialPlSectionsBalances) GetSections() []TrialPlSectionsResponseTrialPlSectionsSections {
	if o == nil || o.Sections == nil {
		var ret []TrialPlSectionsResponseTrialPlSectionsSections
		return ret
	}
	return *o.Sections
}
...
// SetSections gets a reference to the given []TrialPlSectionsResponseTrialPlSectionsSections and assigns it to the Sections field.
...
func (o TrialPlSectionsResponseTrialPlSectionsBalances) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlSectionsResponseTrialPlSectionsBalances struct {
	value *TrialPlSectionsResponseTrialPlSectionsBalances
	isSet bool
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsBalances) Get() *TrialPlSectionsResponseTrialPlSectionsBalances {
	return v.value
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsBalances) Set(val *TrialPlSectionsResponseTrialPlSectionsBalances) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsBalances) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsBalances) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlSectionsResponseTrialPlSectionsBalances(val *TrialPlSectionsResponseTrialPlSectionsBalances) *NullableTrialPlSectionsResponseTrialPlSectionsBalances {
	return &NullableTrialPlSectionsResponseTrialPlSectionsBalances{value: val, isSet: true}
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsBalances) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsBalances) UnmarshalJSON(src []byte) error {
	v.isSet = true
