...
func (o *DealResponseDealUser) SetDisplayNameNil() {
...
func (o DealResponseDealUser) MarshalJSON() ([]byte, error) {
...
type NullableDealResponseDealUser struct {
	value *DealResponseDealUser
	isSet bool
}

func (v NullableDealResponseDealUser) Get() *DealResponseDealUser {
	return v.value
}

func (v *NullableDealResponseDealUser) Set(val *DealResponseDealUser) {
	v.value = val
	v.isSet = true
}

func (v NullableDealResponseDealUser) IsSet() bool {
	return v.isSet
}

func (v *NullableDealResponseDealUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealResponseDealUser(val *DealResponseDealUser) *NullableDealResponseDealUser {
	return &NullableDealResponseDealUser{value: val, isSet: true}
}

func (v NullableDealResponseDealUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealResponseDealUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
