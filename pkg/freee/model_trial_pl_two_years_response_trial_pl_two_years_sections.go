...
// TrialPlTwoYearsResponseTrialPlTwoYearsSections struct for TrialPlTwoYearsResponseTrialPlTwoYearsSections
type TrialPlTwoYearsResponseTrialPlTwoYearsSections struct {
	// 部門ID
	Id int32 `json:"id"`
	// 部門名
...
func NewTrialPlTwoYearsResponseTrialPlTwoYearsSections(id int32, ) *TrialPlTwoYearsResponseTrialPlTwoYearsSections {
	this := TrialPlTwoYearsResponseTrialPlTwoYearsSections{}
	this.Id = id
	return &this
}
...
func (o TrialPlTwoYearsResponseTrialPlTwoYearsSections) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections struct {
	value *TrialPlTwoYearsResponseTrialPlTwoYearsSections
	isSet bool
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) Get() *TrialPlTwoYearsResponseTrialPlTwoYearsSections {
	return v.value
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) Set(val *TrialPlTwoYearsResponseTrialPlTwoYearsSections) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlTwoYearsResponseTrialPlTwoYearsSections(val *TrialPlTwoYearsResponseTrialPlTwoYearsSections) *NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections {
	return &NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections{value: val, isSet: true}
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsSections) UnmarshalJSON(src []byte) error {
	v.isSet = true
