...
func (o ApprovalRequestUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestUpdateParams struct {
	value *ApprovalRequestUpdateParams
	isSet bool
}

func (v NullableApprovalRequestUpdateParams) Get() *ApprovalRequestUpdateParams {
	return v.value
}

func (v *NullableApprovalRequestUpdateParams) Set(val *ApprovalRequestUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestUpdateParams(val *ApprovalRequestUpdateParams) *NullableApprovalRequestUpdateParams {
	return &NullableApprovalRequestUpdateParams{value: val, isSet: true}
}

func (v NullableApprovalRequestUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
