...
func (o WalletTxnParams) MarshalJSON() ([]byte, error) {
...
type NullableWalletTxnParams struct {
	value *WalletTxnParams
	isSet bool
}

func (v NullableWalletTxnParams) Get() *WalletTxnParams {
	return v.value
}

func (v *NullableWalletTxnParams) Set(val *WalletTxnParams) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletTxnParams) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletTxnParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletTxnParams(val *WalletTxnParams) *NullableWalletTxnParams {
	return &NullableWalletTxnParams{value: val, isSet: true}
}

func (v NullableWalletTxnParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletTxnParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
