...
func (o *QuotationUpdateParams) SetPartnerIdNil() {
	o.PartnerId.Set(nil)
}
...
func (o *QuotationUpdateParams) SetPartnerCodeNil() {
...
func (o *QuotationUpdateParams) SetPartnerContactInfoNil() {
...
func (o *QuotationUpdateParams) SetPartnerZipcodeNil() {
...
func (o *QuotationUpdateParams) SetPartnerPrefectureCodeNil() {
...
func (o *QuotationUpdateParams) SetPartnerAddress1Nil() {
...
func (o *QuotationUpdateParams) SetPartnerAddress2Nil() {
...
func (o *QuotationUpdateParams) GetQuotationContents() []QuotationUpdateParamsQuotationContents {
	if o == nil || o.QuotationContents == nil {
		var ret []QuotationUpdateParamsQuotationContents
		return ret
	}
...
// SetQuotationContents gets a reference to the given []QuotationUpdateParamsQuotationContents and assigns it to the QuotationContents field.
func (o *QuotationUpdateParams) SetQuotationContents(v []QuotationUpdateParamsQuotationContents) {
	o.QuotationContents = &v
}

func (o QuotationUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableQuotationUpdateParams struct {
	value *QuotationUpdateParams
	isSet bool
}

func (v NullableQuotationUpdateParams) Get() *QuotationUpdateParams {
	return v.value
}

func (v *NullableQuotationUpdateParams) Set(val *QuotationUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationUpdateParams(val *QuotationUpdateParams) *NullableQuotationUpdateParams {
	return &NullableQuotationUpdateParams{value: val, isSet: true}
}

func (v NullableQuotationUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
