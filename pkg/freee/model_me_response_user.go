...
func (o *MeResponseUser) SetDisplayNameNil() {
...
func (o *MeResponseUser) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *MeResponseUser) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *MeResponseUser) SetFirstNameKanaNil() {
...
func (o *MeResponseUser) SetLastNameKanaNil() {
...
func (o *MeResponseUser) GetCompanies() []MeResponseUserCompanies {
	if o == nil || o.Companies == nil {
		var ret []MeResponseUserCompanies
		return ret
	}
	return *o.Companies
}
...
// SetCompanies gets a reference to the given []MeResponseUserCompanies and assigns it to the Companies field.
func (o *MeResponseUser) SetCompanies(v []MeResponseUserCompanies) {
	o.Companies = &v
}

func (o MeResponseUser) MarshalJSON() ([]byte, error) {
...
type NullableMeResponseUser struct {
	value *MeResponseUser
	isSet bool
}

func (v NullableMeResponseUser) Get() *MeResponseUser {
	return v.value
}

func (v *NullableMeResponseUser) Set(val *MeResponseUser) {
	v.value = val
	v.isSet = true
}

func (v NullableMeResponseUser) IsSet() bool {
	return v.isSet
}

func (v *NullableMeResponseUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeResponseUser(val *MeResponseUser) *NullableMeResponseUser {
	return &NullableMeResponseUser{value: val, isSet: true}
}

func (v NullableMeResponseUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeResponseUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
