...
func (o ItemParams) MarshalJSON() ([]byte, error) {
...
type NullableItemParams struct {
	value *ItemParams
	isSet bool
}

func (v NullableItemParams) Get() *ItemParams {
	return v.value
}

func (v *NullableItemParams) Set(val *ItemParams) {
	v.value = val
	v.isSet = true
}

func (v NullableItemParams) IsSet() bool {
	return v.isSet
}

func (v *NullableItemParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemParams(val *ItemParams) *NullableItemParams {
	return &NullableItemParams{value: val, isSet: true}
}

func (v NullableItemParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
