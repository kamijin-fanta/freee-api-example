...
// TrialBsTwoYearsResponseTrialBsTwoYearsItems struct for TrialBsTwoYearsResponseTrialBsTwoYearsItems
type TrialBsTwoYearsResponseTrialBsTwoYearsItems struct {
	// 品目ID
	Id int32 `json:"id"`
	// 品目
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsItems(id int32, ) *TrialBsTwoYearsResponseTrialBsTwoYearsItems {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsItems{}
	this.Id = id
	return &this
}
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsItems) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsItems
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsItems {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsItems(val *TrialBsTwoYearsResponseTrialBsTwoYearsItems) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
