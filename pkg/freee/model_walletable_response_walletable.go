...
func NewWalletableResponseWalletable(id int32, name string, bankId NullableInt32, type_ string, ) *WalletableResponseWalletable {
	this := WalletableResponseWalletable{}
	this.Id = id
	this.Name = name
	this.BankId = bankId
	this.Type = type_
...
func (o *WalletableResponseWalletable) GetWalletableBalanceOk() (*int32, bool) {
	...
	return o.WalletableBalance, true
}
...
func (o WalletableResponseWalletable) MarshalJSON() ([]byte, error) {
	...
	if o.LastBalance != nil {
		toSerialize["last_balance"] = o.LastBalance
	}
	if o.WalletableBalance != nil {
		toSerialize["walletable_balance"] = o.WalletableBalance
	}
	return json.Marshal(toSerialize)
}

type NullableWalletableResponseWalletable struct {
	value *WalletableResponseWalletable
	isSet bool
}

func (v NullableWalletableResponseWalletable) Get() *WalletableResponseWalletable {
	return v.value
}

func (v *NullableWalletableResponseWalletable) Set(val *WalletableResponseWalletable) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletableResponseWalletable) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletableResponseWalletable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletableResponseWalletable(val *WalletableResponseWalletable) *NullableWalletableResponseWalletable {
	return &NullableWalletableResponseWalletable{value: val, isSet: true}
}

func (v NullableWalletableResponseWalletable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletableResponseWalletable) UnmarshalJSON(src []byte) error {
	v.isSet = true
