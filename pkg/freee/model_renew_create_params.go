...
type RenewCreateParams struct {
	...
	// +更新の明細行
	Details []RenewCreateParamsDetails `json:"details"`
}
...
func (o *RenewCreateParams) GetDetails() []RenewCreateParamsDetails {
	if o == nil  {
		var ret []RenewCreateParamsDetails
		return ret
	}
...
func (o RenewCreateParams) MarshalJSON() ([]byte, error) {
...
type NullableRenewCreateParams struct {
	value *RenewCreateParams
	isSet bool
}

func (v NullableRenewCreateParams) Get() *RenewCreateParams {
	return v.value
}

func (v *NullableRenewCreateParams) Set(val *RenewCreateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRenewCreateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRenewCreateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenewCreateParams(val *RenewCreateParams) *NullableRenewCreateParams {
	return &NullableRenewCreateParams{value: val, isSet: true}
}

func (v NullableRenewCreateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenewCreateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
