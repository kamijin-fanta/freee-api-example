...
// UserCapability struct for UserCapability
...
func (o UserCapability) MarshalJSON() ([]byte, error) {
...
type NullableUserCapability struct {
	value *UserCapability
	isSet bool
}

func (v NullableUserCapability) Get() *UserCapability {
	return v.value
}

func (v *NullableUserCapability) Set(val *UserCapability) {
	v.value = val
	v.isSet = true
}

func (v NullableUserCapability) IsSet() bool {
	return v.isSet
}

func (v *NullableUserCapability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserCapability(val *UserCapability) *NullableUserCapability {
	return &NullableUserCapability{value: val, isSet: true}
}

func (v NullableUserCapability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserCapability) UnmarshalJSON(src []byte) error {
	v.isSet = true
