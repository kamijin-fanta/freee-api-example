...
// ManualJournalCreateParams struct for ManualJournalCreateParams
type ManualJournalCreateParams struct {
	// 事業所ID
	...
	Details []ManualJournalCreateParamsDetails `json:"details"`
}
...
func NewManualJournalCreateParams(companyId int32, issueDate string, details []ManualJournalCreateParamsDetails, ) *ManualJournalCreateParams {
	this := ManualJournalCreateParams{}
...
func (o *ManualJournalCreateParams) GetDetails() []ManualJournalCreateParamsDetails {
	if o == nil  {
		var ret []ManualJournalCreateParamsDetails
		return ret
	}
...
func (o ManualJournalCreateParams) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalCreateParams struct {
	value *ManualJournalCreateParams
	isSet bool
}

func (v NullableManualJournalCreateParams) Get() *ManualJournalCreateParams {
	return v.value
}

func (v *NullableManualJournalCreateParams) Set(val *ManualJournalCreateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalCreateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalCreateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalCreateParams(val *ManualJournalCreateParams) *NullableManualJournalCreateParams {
	return &NullableManualJournalCreateParams{value: val, isSet: true}
}

func (v NullableManualJournalCreateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalCreateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
