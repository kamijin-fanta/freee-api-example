...
// ApprovalRequestsIndexResponseRequestItems struct for ApprovalRequestsIndexResponseRequestItems
type ApprovalRequestsIndexResponseRequestItems struct {
	// 項目ID
	Id int32 `json:"id"`
...
func NewApprovalRequestsIndexResponseRequestItems(id int32, type_ string, value string, ) *ApprovalRequestsIndexResponseRequestItems {
	this := ApprovalRequestsIndexResponseRequestItems{}
	this.Id = id
	this.Type = type_
	this.Value = value
	return &this
...
func (o ApprovalRequestsIndexResponseRequestItems) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestsIndexResponseRequestItems struct {
	value *ApprovalRequestsIndexResponseRequestItems
	isSet bool
}

func (v NullableApprovalRequestsIndexResponseRequestItems) Get() *ApprovalRequestsIndexResponseRequestItems {
	return v.value
}

func (v *NullableApprovalRequestsIndexResponseRequestItems) Set(val *ApprovalRequestsIndexResponseRequestItems) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestsIndexResponseRequestItems) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestsIndexResponseRequestItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestsIndexResponseRequestItems(val *ApprovalRequestsIndexResponseRequestItems) *NullableApprovalRequestsIndexResponseRequestItems {
	return &NullableApprovalRequestsIndexResponseRequestItems{value: val, isSet: true}
}

func (v NullableApprovalRequestsIndexResponseRequestItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestsIndexResponseRequestItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
