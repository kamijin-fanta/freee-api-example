...
// ApprovalFlowRouteResponseApprovalFlowRouteSteps struct for ApprovalFlowRouteResponseApprovalFlowRouteSteps
type ApprovalFlowRouteResponseApprovalFlowRouteSteps struct {
	// 承認ステップID
	Id int32 `json:"id"`
	// 次の承認ステップID
	NextStepId NullableInt32 `json:"next_step_id"`
...
func NewApprovalFlowRouteResponseApprovalFlowRouteSteps(id int32, nextStepId NullableInt32, resourceType string, ) *ApprovalFlowRouteResponseApprovalFlowRouteSteps {
	this := ApprovalFlowRouteResponseApprovalFlowRouteSteps{}
	this.Id = id
...
func (o *ApprovalFlowRouteResponseApprovalFlowRouteSteps) GetNextStepId() int32 {
	if o == nil || o.NextStepId.Get() == nil {
		var ret int32
		return ret
	}

	return *o.NextStepId.Get()
}
...
func (o *ApprovalFlowRouteResponseApprovalFlowRouteSteps) GetNextStepIdOk() (*int32, bool) {
	...
	return o.NextStepId.Get(), o.NextStepId.IsSet()
}
...
func (o ApprovalFlowRouteResponseApprovalFlowRouteSteps) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["id"] = o.Id
	}
	if true {
		toSerialize["next_step_id"] = o.NextStepId.Get()
	}
	if true {
...
type NullableApprovalFlowRouteResponseApprovalFlowRouteSteps struct {
	value *ApprovalFlowRouteResponseApprovalFlowRouteSteps
	isSet bool
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) Get() *ApprovalFlowRouteResponseApprovalFlowRouteSteps {
	return v.value
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) Set(val *ApprovalFlowRouteResponseApprovalFlowRouteSteps) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalFlowRouteResponseApprovalFlowRouteSteps(val *ApprovalFlowRouteResponseApprovalFlowRouteSteps) *NullableApprovalFlowRouteResponseApprovalFlowRouteSteps {
	return &NullableApprovalFlowRouteResponseApprovalFlowRouteSteps{value: val, isSet: true}
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteSteps) UnmarshalJSON(src []byte) error {
	v.isSet = true
