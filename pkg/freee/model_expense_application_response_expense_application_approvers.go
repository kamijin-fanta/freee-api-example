...
// ExpenseApplicationResponseExpenseApplicationApprovers struct for ExpenseApplicationResponseExpenseApplicationApprovers
type ExpenseApplicationResponseExpenseApplicationApprovers struct {
	// 承認ステップID
...
func NewExpenseApplicationResponseExpenseApplicationApprovers(stepId int32, userId NullableInt32, status string, isForceAction bool, resourceType string, ) *ExpenseApplicationResponseExpenseApplicationApprovers {
	this := ExpenseApplicationResponseExpenseApplicationApprovers{}
	this.StepId = stepId
	this.UserId = userId
	this.Status = status
...
func (o ExpenseApplicationResponseExpenseApplicationApprovers) MarshalJSON() ([]byte, error) {
...
type NullableExpenseApplicationResponseExpenseApplicationApprovers struct {
	value *ExpenseApplicationResponseExpenseApplicationApprovers
	isSet bool
}

func (v NullableExpenseApplicationResponseExpenseApplicationApprovers) Get() *ExpenseApplicationResponseExpenseApplicationApprovers {
	return v.value
}

func (v *NullableExpenseApplicationResponseExpenseApplicationApprovers) Set(val *ExpenseApplicationResponseExpenseApplicationApprovers) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseApplicationResponseExpenseApplicationApprovers) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseApplicationResponseExpenseApplicationApprovers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseApplicationResponseExpenseApplicationApprovers(val *ExpenseApplicationResponseExpenseApplicationApprovers) *NullableExpenseApplicationResponseExpenseApplicationApprovers {
	return &NullableExpenseApplicationResponseExpenseApplicationApprovers{value: val, isSet: true}
}

func (v NullableExpenseApplicationResponseExpenseApplicationApprovers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseApplicationResponseExpenseApplicationApprovers) UnmarshalJSON(src []byte) error {
	v.isSet = true
