...
func (o *InvoiceCreateParams) SetPartnerIdNil() {
	o.PartnerId.Set(nil)
}
...
func (o *InvoiceCreateParams) SetPartnerCodeNil() {
...
func (o *InvoiceCreateParams) SetPartnerContactInfoNil() {
...
func (o *InvoiceCreateParams) SetPartnerZipcodeNil() {
...
func (o *InvoiceCreateParams) SetPartnerPrefectureCodeNil() {
...
func (o *InvoiceCreateParams) SetPartnerAddress1Nil() {
...
func (o *InvoiceCreateParams) SetPartnerAddress2Nil() {
...
func (o InvoiceCreateParams) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceCreateParams struct {
	value *InvoiceCreateParams
	isSet bool
}

func (v NullableInvoiceCreateParams) Get() *InvoiceCreateParams {
	return v.value
}

func (v *NullableInvoiceCreateParams) Set(val *InvoiceCreateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceCreateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceCreateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceCreateParams(val *InvoiceCreateParams) *NullableInvoiceCreateParams {
	return &NullableInvoiceCreateParams{value: val, isSet: true}
}

func (v NullableInvoiceCreateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceCreateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
