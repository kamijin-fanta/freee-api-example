...
// PaymentRequestCreateParamsPaymentRequestLines struct for PaymentRequestCreateParamsPaymentRequestLines
type PaymentRequestCreateParamsPaymentRequestLines struct {
...
func NewPaymentRequestCreateParamsPaymentRequestLines(amount int32, taxCode int32, ) *PaymentRequestCreateParamsPaymentRequestLines {
	this := PaymentRequestCreateParamsPaymentRequestLines{}
	this.Amount = amount
...
func (o PaymentRequestCreateParamsPaymentRequestLines) MarshalJSON() ([]byte, error) {
...
type NullablePaymentRequestCreateParamsPaymentRequestLines struct {
	value *PaymentRequestCreateParamsPaymentRequestLines
	isSet bool
}

func (v NullablePaymentRequestCreateParamsPaymentRequestLines) Get() *PaymentRequestCreateParamsPaymentRequestLines {
	return v.value
}

func (v *NullablePaymentRequestCreateParamsPaymentRequestLines) Set(val *PaymentRequestCreateParamsPaymentRequestLines) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentRequestCreateParamsPaymentRequestLines) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentRequestCreateParamsPaymentRequestLines) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentRequestCreateParamsPaymentRequestLines(val *PaymentRequestCreateParamsPaymentRequestLines) *NullablePaymentRequestCreateParamsPaymentRequestLines {
	return &NullablePaymentRequestCreateParamsPaymentRequestLines{value: val, isSet: true}
}

func (v NullablePaymentRequestCreateParamsPaymentRequestLines) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentRequestCreateParamsPaymentRequestLines) UnmarshalJSON(src []byte) error {
	v.isSet = true
