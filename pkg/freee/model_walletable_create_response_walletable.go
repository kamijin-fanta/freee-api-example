...
func (o WalletableCreateResponseWalletable) MarshalJSON() ([]byte, error) {
...
type NullableWalletableCreateResponseWalletable struct {
	value *WalletableCreateResponseWalletable
	isSet bool
}

func (v NullableWalletableCreateResponseWalletable) Get() *WalletableCreateResponseWalletable {
	return v.value
}

func (v *NullableWalletableCreateResponseWalletable) Set(val *WalletableCreateResponseWalletable) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletableCreateResponseWalletable) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletableCreateResponseWalletable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletableCreateResponseWalletable(val *WalletableCreateResponseWalletable) *NullableWalletableCreateResponseWalletable {
	return &NullableWalletableCreateResponseWalletable{value: val, isSet: true}
}

func (v NullableWalletableCreateResponseWalletable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletableCreateResponseWalletable) UnmarshalJSON(src []byte) error {
	v.isSet = true
