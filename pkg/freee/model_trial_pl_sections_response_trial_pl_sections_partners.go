...
// TrialPlSectionsResponseTrialPlSectionsPartners struct for TrialPlSectionsResponseTrialPlSectionsPartners
type TrialPlSectionsResponseTrialPlSectionsPartners struct {
	// 取引先ID
	Id int32 `json:"id"`
	// 取引先名
...
func NewTrialPlSectionsResponseTrialPlSectionsPartners(id int32, ) *TrialPlSectionsResponseTrialPlSectionsPartners {
	this := TrialPlSectionsResponseTrialPlSectionsPartners{}
	this.Id = id
	return &this
}
...
func (o TrialPlSectionsResponseTrialPlSectionsPartners) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlSectionsResponseTrialPlSectionsPartners struct {
	value *TrialPlSectionsResponseTrialPlSectionsPartners
	isSet bool
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsPartners) Get() *TrialPlSectionsResponseTrialPlSectionsPartners {
	return v.value
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsPartners) Set(val *TrialPlSectionsResponseTrialPlSectionsPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsPartners) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsPartners) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlSectionsResponseTrialPlSectionsPartners(val *TrialPlSectionsResponseTrialPlSectionsPartners) *NullableTrialPlSectionsResponseTrialPlSectionsPartners {
	return &NullableTrialPlSectionsResponseTrialPlSectionsPartners{value: val, isSet: true}
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsPartners) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsPartners) UnmarshalJSON(src []byte) error {
	v.isSet = true
