...
// ApprovalRequestFormResponse struct for ApprovalRequestFormResponse
type ApprovalRequestFormResponse struct {
	ApprovalRequestForm ApprovalRequestFormResponseApprovalRequestForm `json:"approval_request_form"`
}
...
func NewApprovalRequestFormResponse(approvalRequestForm ApprovalRequestFormResponseApprovalRequestForm, ) *ApprovalRequestFormResponse {
	this := ApprovalRequestFormResponse{}
...
func (o *ApprovalRequestFormResponse) GetApprovalRequestForm() ApprovalRequestFormResponseApprovalRequestForm {
	if o == nil  {
		var ret ApprovalRequestFormResponseApprovalRequestForm
		return ret
	}
...
func (o ApprovalRequestFormResponse) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestFormResponse struct {
	value *ApprovalRequestFormResponse
	isSet bool
}

func (v NullableApprovalRequestFormResponse) Get() *ApprovalRequestFormResponse {
	return v.value
}

func (v *NullableApprovalRequestFormResponse) Set(val *ApprovalRequestFormResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestFormResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestFormResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestFormResponse(val *ApprovalRequestFormResponse) *NullableApprovalRequestFormResponse {
	return &NullableApprovalRequestFormResponse{value: val, isSet: true}
}

func (v NullableApprovalRequestFormResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestFormResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
