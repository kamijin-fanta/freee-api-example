...
func NewApprovalRequestFormResponseApprovalRequestForm(id int32, companyId int32, name string, description string, status string, createdDate string, formOrder NullableInt32, routeSettingCount int32, ) *ApprovalRequestFormResponseApprovalRequestForm {
	this := ApprovalRequestFormResponseApprovalRequestForm{}
	this.Id = id
...
// SetParts gets a reference to the given []ApprovalRequestResponseApprovalRequestApprovalRequestFormParts and assigns it to the Parts field.
...
func (o ApprovalRequestFormResponseApprovalRequestForm) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestFormResponseApprovalRequestForm struct {
	value *ApprovalRequestFormResponseApprovalRequestForm
	isSet bool
}

func (v NullableApprovalRequestFormResponseApprovalRequestForm) Get() *ApprovalRequestFormResponseApprovalRequestForm {
	return v.value
}

func (v *NullableApprovalRequestFormResponseApprovalRequestForm) Set(val *ApprovalRequestFormResponseApprovalRequestForm) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestFormResponseApprovalRequestForm) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestFormResponseApprovalRequestForm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestFormResponseApprovalRequestForm(val *ApprovalRequestFormResponseApprovalRequestForm) *NullableApprovalRequestFormResponseApprovalRequestForm {
	return &NullableApprovalRequestFormResponseApprovalRequestForm{value: val, isSet: true}
}

func (v NullableApprovalRequestFormResponseApprovalRequestForm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestFormResponseApprovalRequestForm) UnmarshalJSON(src []byte) error {
	v.isSet = true
