...
func NewQuotationUpdateParamsQuotationContents(order int32, type_ string, ) *QuotationUpdateParamsQuotationContents {
	this := QuotationUpdateParamsQuotationContents{}
	this.Order = order
	this.Type = type_
	return &this
}
...
func (o *QuotationUpdateParamsQuotationContents) SetVatNil() {
	o.Vat.Set(nil)
}
...
func (o QuotationUpdateParamsQuotationContents) MarshalJSON() ([]byte, error) {
...
type NullableQuotationUpdateParamsQuotationContents struct {
	value *QuotationUpdateParamsQuotationContents
	isSet bool
}

func (v NullableQuotationUpdateParamsQuotationContents) Get() *QuotationUpdateParamsQuotationContents {
	return v.value
}

func (v *NullableQuotationUpdateParamsQuotationContents) Set(val *QuotationUpdateParamsQuotationContents) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationUpdateParamsQuotationContents) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationUpdateParamsQuotationContents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationUpdateParamsQuotationContents(val *QuotationUpdateParamsQuotationContents) *NullableQuotationUpdateParamsQuotationContents {
	return &NullableQuotationUpdateParamsQuotationContents{value: val, isSet: true}
}

func (v NullableQuotationUpdateParamsQuotationContents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationUpdateParamsQuotationContents) UnmarshalJSON(src []byte) error {
	v.isSet = true
