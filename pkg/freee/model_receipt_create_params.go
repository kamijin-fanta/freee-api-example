...
func (o ReceiptCreateParams) MarshalJSON() ([]byte, error) {
...
type NullableReceiptCreateParams struct {
	value *ReceiptCreateParams
	isSet bool
}

func (v NullableReceiptCreateParams) Get() *ReceiptCreateParams {
	return v.value
}

func (v *NullableReceiptCreateParams) Set(val *ReceiptCreateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableReceiptCreateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableReceiptCreateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReceiptCreateParams(val *ReceiptCreateParams) *NullableReceiptCreateParams {
	return &NullableReceiptCreateParams{value: val, isSet: true}
}

func (v NullableReceiptCreateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReceiptCreateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
