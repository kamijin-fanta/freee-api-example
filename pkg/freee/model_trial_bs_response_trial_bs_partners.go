...
func NewTrialBsResponseTrialBsPartners(id int32, ) *TrialBsResponseTrialBsPartners {
	this := TrialBsResponseTrialBsPartners{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsPartners) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsPartners struct {
	value *TrialBsResponseTrialBsPartners
	isSet bool
}

func (v NullableTrialBsResponseTrialBsPartners) Get() *TrialBsResponseTrialBsPartners {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsPartners) Set(val *TrialBsResponseTrialBsPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsPartners) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsPartners) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsPartners(val *TrialBsResponseTrialBsPartners) *NullableTrialBsResponseTrialBsPartners {
	return &NullableTrialBsResponseTrialBsPartners{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsPartners) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsPartners) UnmarshalJSON(src []byte) error {
	v.isSet = true
