...
func NewCompanyUpdateResponseCompanyFiscalYears(useIndustryTemplate bool, indirectWriteOffMethod bool, indirectWriteOffMethodType bool, depreciationRecordMethod int32, taxMethod int32, salesTaxBusinessCode int32, taxFraction int32, taxAccountMethod int32, returnCode int32, ) *CompanyUpdateResponseCompanyFiscalYears {
	this := CompanyUpdateResponseCompanyFiscalYears{}
...
// GetUseIndustryTemplate returns the UseIndustryTemplate field value
...
// SetUseIndustryTemplate sets field value
func (o *CompanyUpdateResponseCompanyFiscalYears) SetUseIndustryTemplate(v bool) {
	o.UseIndustryTemplate = v
}

// GetIndirectWriteOffMethod returns the IndirectWriteOffMethod field value
...
// SetIndirectWriteOffMethod sets field value
func (o *CompanyUpdateResponseCompanyFiscalYears) SetIndirectWriteOffMethod(v bool) {
	o.IndirectWriteOffMethod = v
}

// GetIndirectWriteOffMethodType returns the IndirectWriteOffMethodType field value
...
// GetIndirectWriteOffMethodTypeOk returns a tuple with the IndirectWriteOffMethodType field value
// and a boolean to check if the value has been set.
...
// SetIndirectWriteOffMethodType sets field value
...
func (o *CompanyUpdateResponseCompanyFiscalYears) GetDepreciationRecordMethod() int32 {
	...
	return o.DepreciationRecordMethod
}
...
func (o CompanyUpdateResponseCompanyFiscalYears) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["depreciation_record_method"] = o.DepreciationRecordMethod
	}
	if true {
		toSerialize["tax_method"] = o.TaxMethod
	}
	if true {
		toSerialize["sales_tax_business_code"] = o.SalesTaxBusinessCode
	}
	if true {
		toSerialize["tax_fraction"] = o.TaxFraction
	}
	if true {
		toSerialize["tax_account_method"] = o.TaxAccountMethod
	}
	if true {
...
type NullableCompanyUpdateResponseCompanyFiscalYears struct {
	value *CompanyUpdateResponseCompanyFiscalYears
	isSet bool
}

func (v NullableCompanyUpdateResponseCompanyFiscalYears) Get() *CompanyUpdateResponseCompanyFiscalYears {
	return v.value
}

func (v *NullableCompanyUpdateResponseCompanyFiscalYears) Set(val *CompanyUpdateResponseCompanyFiscalYears) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyUpdateResponseCompanyFiscalYears) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyUpdateResponseCompanyFiscalYears) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyUpdateResponseCompanyFiscalYears(val *CompanyUpdateResponseCompanyFiscalYears) *NullableCompanyUpdateResponseCompanyFiscalYears {
	return &NullableCompanyUpdateResponseCompanyFiscalYears{value: val, isSet: true}
}

func (v NullableCompanyUpdateResponseCompanyFiscalYears) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyUpdateResponseCompanyFiscalYears) UnmarshalJSON(src []byte) error {
	v.isSet = true
