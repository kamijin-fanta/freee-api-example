...
type InlineResponse20016 struct {
	ApprovalRequestForms []ApprovalRequestForm `json:"approval_request_forms"`
}
...
// GetApprovalRequestForms returns the ApprovalRequestForms field value
func (o *InlineResponse20016) GetApprovalRequestForms() []ApprovalRequestForm {
	if o == nil  {
		var ret []ApprovalRequestForm
		return ret
	}

	return o.ApprovalRequestForms
}

// GetApprovalRequestFormsOk returns a tuple with the ApprovalRequestForms field value
// and a boolean to check if the value has been set.
func (o *InlineResponse20016) GetApprovalRequestFormsOk() (*[]ApprovalRequestForm, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ApprovalRequestForms, true
}

// SetApprovalRequestForms sets field value
func (o *InlineResponse20016) SetApprovalRequestForms(v []ApprovalRequestForm) {
	o.ApprovalRequestForms = v
}

func (o InlineResponse20016) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["approval_request_forms"] = o.ApprovalRequestForms
	}
