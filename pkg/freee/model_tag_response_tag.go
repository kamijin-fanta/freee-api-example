...
// TagResponseTag struct for TagResponseTag
type TagResponseTag struct {
	// タグID
	Id int32 `json:"id"`
	// 事業所ID
...
func (o *TagResponseTag) SetShortcut1Nil() {
	o.Shortcut1.Set(nil)
}
...
func (o *TagResponseTag) SetShortcut2Nil() {
	o.Shortcut2.Set(nil)
}
...
func (o TagResponseTag) MarshalJSON() ([]byte, error) {
...
type NullableTagResponseTag struct {
	value *TagResponseTag
	isSet bool
}

func (v NullableTagResponseTag) Get() *TagResponseTag {
	return v.value
}

func (v *NullableTagResponseTag) Set(val *TagResponseTag) {
	v.value = val
	v.isSet = true
}

func (v NullableTagResponseTag) IsSet() bool {
	return v.isSet
}

func (v *NullableTagResponseTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagResponseTag(val *TagResponseTag) *NullableTagResponseTag {
	return &NullableTagResponseTag{value: val, isSet: true}
}

func (v NullableTagResponseTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagResponseTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
