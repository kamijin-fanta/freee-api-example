...
func (o *DealUpdateParams) GetDetails() []DealUpdateParamsDetails {
	if o == nil  {
		var ret []DealUpdateParamsDetails
		return ret
	}
...
func (o DealUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableDealUpdateParams struct {
	value *DealUpdateParams
	isSet bool
}

func (v NullableDealUpdateParams) Get() *DealUpdateParams {
	return v.value
}

func (v *NullableDealUpdateParams) Set(val *DealUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUpdateParams(val *DealUpdateParams) *NullableDealUpdateParams {
	return &NullableDealUpdateParams{value: val, isSet: true}
}

func (v NullableDealUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
