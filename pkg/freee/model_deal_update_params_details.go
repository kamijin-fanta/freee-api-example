...
func (o DealUpdateParamsDetails) MarshalJSON() ([]byte, error) {
...
type NullableDealUpdateParamsDetails struct {
	value *DealUpdateParamsDetails
	isSet bool
}

func (v NullableDealUpdateParamsDetails) Get() *DealUpdateParamsDetails {
	return v.value
}

func (v *NullableDealUpdateParamsDetails) Set(val *DealUpdateParamsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUpdateParamsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUpdateParamsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUpdateParamsDetails(val *DealUpdateParamsDetails) *NullableDealUpdateParamsDetails {
	return &NullableDealUpdateParamsDetails{value: val, isSet: true}
}

func (v NullableDealUpdateParamsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUpdateParamsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
