...
type RenewUpdateParams struct {
	...
	// +更新の明細行
	Details []RenewUpdateParamsDetails `json:"details"`
}
...
func (o *RenewUpdateParams) GetDetails() []RenewUpdateParamsDetails {
	if o == nil  {
		var ret []RenewUpdateParamsDetails
		return ret
	}
...
func (o RenewUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableRenewUpdateParams struct {
	value *RenewUpdateParams
	isSet bool
}

func (v NullableRenewUpdateParams) Get() *RenewUpdateParams {
	return v.value
}

func (v *NullableRenewUpdateParams) Set(val *RenewUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRenewUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRenewUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenewUpdateParams(val *RenewUpdateParams) *NullableRenewUpdateParams {
	return &NullableRenewUpdateParams{value: val, isSet: true}
}

func (v NullableRenewUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenewUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
