...
func (r ApiGetItemsRequest) Execute() (InlineResponse2006, *_nethttp.Response, error) {
 ...
 */
func (a *ItemsApiService) GetItemsExecute(r ApiGetItemsRequest) (InlineResponse2006, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
