...
func (o RenewCreateParamsDetails) MarshalJSON() ([]byte, error) {
...
type NullableRenewCreateParamsDetails struct {
	value *RenewCreateParamsDetails
	isSet bool
}

func (v NullableRenewCreateParamsDetails) Get() *RenewCreateParamsDetails {
	return v.value
}

func (v *NullableRenewCreateParamsDetails) Set(val *RenewCreateParamsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableRenewCreateParamsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableRenewCreateParamsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenewCreateParamsDetails(val *RenewCreateParamsDetails) *NullableRenewCreateParamsDetails {
	return &NullableRenewCreateParamsDetails{value: val, isSet: true}
}

func (v NullableRenewCreateParamsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenewCreateParamsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
