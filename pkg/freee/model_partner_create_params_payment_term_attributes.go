...
func NewPartnerCreateParamsPaymentTermAttributes() *PartnerCreateParamsPaymentTermAttributes {
	this := PartnerCreateParamsPaymentTermAttributes{}
	return &this
}
...
func (o PartnerCreateParamsPaymentTermAttributes) MarshalJSON() ([]byte, error) {
...
type NullablePartnerCreateParamsPaymentTermAttributes struct {
	value *PartnerCreateParamsPaymentTermAttributes
	isSet bool
}

func (v NullablePartnerCreateParamsPaymentTermAttributes) Get() *PartnerCreateParamsPaymentTermAttributes {
	return v.value
}

func (v *NullablePartnerCreateParamsPaymentTermAttributes) Set(val *PartnerCreateParamsPaymentTermAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerCreateParamsPaymentTermAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerCreateParamsPaymentTermAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerCreateParamsPaymentTermAttributes(val *PartnerCreateParamsPaymentTermAttributes) *NullablePartnerCreateParamsPaymentTermAttributes {
	return &NullablePartnerCreateParamsPaymentTermAttributes{value: val, isSet: true}
}

func (v NullablePartnerCreateParamsPaymentTermAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerCreateParamsPaymentTermAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
