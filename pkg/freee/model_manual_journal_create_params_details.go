...
func NewManualJournalCreateParamsDetails(entrySide string, taxCode int32, accountItemId int32, amount int32, ) *ManualJournalCreateParamsDetails {
	this := ManualJournalCreateParamsDetails{}
...
func (o ManualJournalCreateParamsDetails) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalCreateParamsDetails struct {
	value *ManualJournalCreateParamsDetails
	isSet bool
}

func (v NullableManualJournalCreateParamsDetails) Get() *ManualJournalCreateParamsDetails {
	return v.value
}

func (v *NullableManualJournalCreateParamsDetails) Set(val *ManualJournalCreateParamsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalCreateParamsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalCreateParamsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalCreateParamsDetails(val *ManualJournalCreateParamsDetails) *NullableManualJournalCreateParamsDetails {
	return &NullableManualJournalCreateParamsDetails{value: val, isSet: true}
}

func (v NullableManualJournalCreateParamsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalCreateParamsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
