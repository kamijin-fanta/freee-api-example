...
func (r ApiGetTransfersRequest) Offset(offset int32) ApiGetTransfersRequest {
	r.offset = &offset
	return r
}
...
func (r ApiGetTransfersRequest) Execute() (InlineResponse20012, *_nethttp.Response, error) {
 ...
 */
func (a *TransfersApiService) GetTransfersExecute(r ApiGetTransfersRequest) (InlineResponse20012, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *TransfersApiService) UpdateTransferExecute(r ApiUpdateTransferRequest) (TransferResponse, *_nethttp.Response, error) {
	...
	if r.transferParams == nil {
		return localVarReturnValue, nil, reportError("transferParams is required and must be specified")
	}
