...
func (o WalletableUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableWalletableUpdateParams struct {
	value *WalletableUpdateParams
	isSet bool
}

func (v NullableWalletableUpdateParams) Get() *WalletableUpdateParams {
	return v.value
}

func (v *NullableWalletableUpdateParams) Set(val *WalletableUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletableUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletableUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletableUpdateParams(val *WalletableUpdateParams) *NullableWalletableUpdateParams {
	return &NullableWalletableUpdateParams{value: val, isSet: true}
}

func (v NullableWalletableUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletableUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
