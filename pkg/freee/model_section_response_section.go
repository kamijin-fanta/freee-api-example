...
func (o *SectionResponseSection) SetLongNameNil() {
	o.LongName.Set(nil)
}
...
func (o *SectionResponseSection) SetShortcut1Nil() {
	o.Shortcut1.Set(nil)
}
...
func (o *SectionResponseSection) SetShortcut2Nil() {
	o.Shortcut2.Set(nil)
}
...
func (o SectionResponseSection) MarshalJSON() ([]byte, error) {
...
type NullableSectionResponseSection struct {
	value *SectionResponseSection
	isSet bool
}

func (v NullableSectionResponseSection) Get() *SectionResponseSection {
	return v.value
}

func (v *NullableSectionResponseSection) Set(val *SectionResponseSection) {
	v.value = val
	v.isSet = true
}

func (v NullableSectionResponseSection) IsSet() bool {
	return v.isSet
}

func (v *NullableSectionResponseSection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSectionResponseSection(val *SectionResponseSection) *NullableSectionResponseSection {
	return &NullableSectionResponseSection{value: val, isSet: true}
}

func (v NullableSectionResponseSection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSectionResponseSection) UnmarshalJSON(src []byte) error {
	v.isSet = true
