...
// SegmentTagResponseSegmentTag struct for SegmentTagResponseSegmentTag
type SegmentTagResponseSegmentTag struct {
	// セグメントタグID
	Id int32 `json:"id"`
	// セグメントタグ名
	...
	// ショートカット１ (20文字以内)
	Shortcut1 NullableString `json:"shortcut1"`
	// ショートカット２ (20文字以内)
	Shortcut2 NullableString `json:"shortcut2"`
}
...
func NewSegmentTagResponseSegmentTag(id int32, name string, description NullableString, shortcut1 NullableString, shortcut2 NullableString, ) *SegmentTagResponseSegmentTag {
	this := SegmentTagResponseSegmentTag{}
	this.Id = id
	this.Name = name
...
// GetShortcut1 returns the Shortcut1 field value
// If the value is explicit nil, the zero value for string will be returned
...
// GetShortcut1Ok returns a tuple with the Shortcut1 field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetShortcut1 sets field value
func (o *SegmentTagResponseSegmentTag) SetShortcut1(v string) {
	o.Shortcut1.Set(&v)
}

// GetShortcut2 returns the Shortcut2 field value
// If the value is explicit nil, the zero value for string will be returned
...
// GetShortcut2Ok returns a tuple with the Shortcut2 field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetShortcut2 sets field value
func (o *SegmentTagResponseSegmentTag) SetShortcut2(v string) {
	o.Shortcut2.Set(&v)
}

func (o SegmentTagResponseSegmentTag) MarshalJSON() ([]byte, error) {
...
type NullableSegmentTagResponseSegmentTag struct {
	value *SegmentTagResponseSegmentTag
	isSet bool
}

func (v NullableSegmentTagResponseSegmentTag) Get() *SegmentTagResponseSegmentTag {
	return v.value
}

func (v *NullableSegmentTagResponseSegmentTag) Set(val *SegmentTagResponseSegmentTag) {
	v.value = val
	v.isSet = true
}

func (v NullableSegmentTagResponseSegmentTag) IsSet() bool {
	return v.isSet
}

func (v *NullableSegmentTagResponseSegmentTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSegmentTagResponseSegmentTag(val *SegmentTagResponseSegmentTag) *NullableSegmentTagResponseSegmentTag {
	return &NullableSegmentTagResponseSegmentTag{value: val, isSet: true}
}

func (v NullableSegmentTagResponseSegmentTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSegmentTagResponseSegmentTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
