...
func NewTrialBsResponseTrialBsItems(id int32, ) *TrialBsResponseTrialBsItems {
	this := TrialBsResponseTrialBsItems{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsItems) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsItems struct {
	value *TrialBsResponseTrialBsItems
	isSet bool
}

func (v NullableTrialBsResponseTrialBsItems) Get() *TrialBsResponseTrialBsItems {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsItems) Set(val *TrialBsResponseTrialBsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsItems(val *TrialBsResponseTrialBsItems) *NullableTrialBsResponseTrialBsItems {
	return &NullableTrialBsResponseTrialBsItems{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
