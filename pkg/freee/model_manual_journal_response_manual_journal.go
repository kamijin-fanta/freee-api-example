...
func NewManualJournalResponseManualJournal(id int32, companyId int32, issueDate string, adjustment bool, txnNumber NullableString, details []ManualJournalResponseManualJournalDetails, ) *ManualJournalResponseManualJournal {
	this := ManualJournalResponseManualJournal{}
	this.Id = id
...
func (o *ManualJournalResponseManualJournal) GetDetails() []ManualJournalResponseManualJournalDetails {
	if o == nil  {
		var ret []ManualJournalResponseManualJournalDetails
		return ret
	}
...
func (o ManualJournalResponseManualJournal) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalResponseManualJournal struct {
	value *ManualJournalResponseManualJournal
	isSet bool
}

func (v NullableManualJournalResponseManualJournal) Get() *ManualJournalResponseManualJournal {
	return v.value
}

func (v *NullableManualJournalResponseManualJournal) Set(val *ManualJournalResponseManualJournal) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalResponseManualJournal) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalResponseManualJournal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalResponseManualJournal(val *ManualJournalResponseManualJournal) *NullableManualJournalResponseManualJournal {
	return &NullableManualJournalResponseManualJournal{value: val, isSet: true}
}

func (v NullableManualJournalResponseManualJournal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalResponseManualJournal) UnmarshalJSON(src []byte) error {
	v.isSet = true
