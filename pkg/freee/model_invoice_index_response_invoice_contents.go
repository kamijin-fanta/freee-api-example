...
// InvoiceIndexResponseInvoiceContents struct for InvoiceIndexResponseInvoiceContents
type InvoiceIndexResponseInvoiceContents struct {
	// 請求内容ID
	Id int32 `json:"id"`
	// 順序
...
func NewInvoiceIndexResponseInvoiceContents(id int32, order int32, type_ string, qty float32, unit NullableString, unitPrice float32, amount int32, vat int32, reducedVat bool, description NullableString, accountItemId NullableInt32, accountItemName NullableString, taxCode NullableInt32, itemId NullableInt32, itemName NullableString, sectionId NullableInt32, sectionName NullableString, tagIds []int32, tagNames []string, ) *InvoiceIndexResponseInvoiceContents {
	this := InvoiceIndexResponseInvoiceContents{}
	this.Id = id
	this.Order = order
	this.Type = type_
	this.Qty = qty
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment1TagIdNil() {
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment1TagNameNil() {
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment2TagIdNil() {
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment2TagNameNil() {
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment3TagIdNil() {
...
func (o *InvoiceIndexResponseInvoiceContents) SetSegment3TagNameNil() {
...
func (o InvoiceIndexResponseInvoiceContents) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceIndexResponseInvoiceContents struct {
	value *InvoiceIndexResponseInvoiceContents
	isSet bool
}

func (v NullableInvoiceIndexResponseInvoiceContents) Get() *InvoiceIndexResponseInvoiceContents {
	return v.value
}

func (v *NullableInvoiceIndexResponseInvoiceContents) Set(val *InvoiceIndexResponseInvoiceContents) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceIndexResponseInvoiceContents) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceIndexResponseInvoiceContents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceIndexResponseInvoiceContents(val *InvoiceIndexResponseInvoiceContents) *NullableInvoiceIndexResponseInvoiceContents {
	return &NullableInvoiceIndexResponseInvoiceContents{value: val, isSet: true}
}

func (v NullableInvoiceIndexResponseInvoiceContents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceIndexResponseInvoiceContents) UnmarshalJSON(src []byte) error {
	v.isSet = true
