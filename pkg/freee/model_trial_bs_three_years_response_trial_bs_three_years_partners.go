...
func NewTrialBsThreeYearsResponseTrialBsThreeYearsPartners(id int32, ) *TrialBsThreeYearsResponseTrialBsThreeYearsPartners {
	this := TrialBsThreeYearsResponseTrialBsThreeYearsPartners{}
	this.Id = id
	return &this
}
...
func (o TrialBsThreeYearsResponseTrialBsThreeYearsPartners) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners struct {
	value *TrialBsThreeYearsResponseTrialBsThreeYearsPartners
	isSet bool
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) Get() *TrialBsThreeYearsResponseTrialBsThreeYearsPartners {
	return v.value
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) Set(val *TrialBsThreeYearsResponseTrialBsThreeYearsPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners(val *TrialBsThreeYearsResponseTrialBsThreeYearsPartners) *NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners {
	return &NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners{value: val, isSet: true}
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsPartners) UnmarshalJSON(src []byte) error {
	v.isSet = true
