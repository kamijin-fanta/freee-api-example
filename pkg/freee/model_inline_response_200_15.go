...
// GetExpenseApplicationLineTemplates returns the ExpenseApplicationLineTemplates field value
func (o *InlineResponse20015) GetExpenseApplicationLineTemplates() []ExpenseApplicationLineTemplate {
	if o == nil  {
		var ret []ExpenseApplicationLineTemplate
		return ret
	}

	return o.ExpenseApplicationLineTemplates
}

// GetExpenseApplicationLineTemplatesOk returns a tuple with the ExpenseApplicationLineTemplates field value
// and a boolean to check if the value has been set.
func (o *InlineResponse20015) GetExpenseApplicationLineTemplatesOk() (*[]ExpenseApplicationLineTemplate, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ExpenseApplicationLineTemplates, true
}

// SetExpenseApplicationLineTemplates sets field value
func (o *InlineResponse20015) SetExpenseApplicationLineTemplates(v []ExpenseApplicationLineTemplate) {
	o.ExpenseApplicationLineTemplates = v
}

func (o InlineResponse20015) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["expense_application_line_templates"] = o.ExpenseApplicationLineTemplates
	}
