...
// ExpenseApplicationUpdateParamsExpenseApplicationLines struct for ExpenseApplicationUpdateParamsExpenseApplicationLines
type ExpenseApplicationUpdateParamsExpenseApplicationLines struct {
...
func NewExpenseApplicationUpdateParamsExpenseApplicationLines() *ExpenseApplicationUpdateParamsExpenseApplicationLines {
	this := ExpenseApplicationUpdateParamsExpenseApplicationLines{}
	return &this
}
...
func (o ExpenseApplicationUpdateParamsExpenseApplicationLines) MarshalJSON() ([]byte, error) {
...
type NullableExpenseApplicationUpdateParamsExpenseApplicationLines struct {
	value *ExpenseApplicationUpdateParamsExpenseApplicationLines
	isSet bool
}

func (v NullableExpenseApplicationUpdateParamsExpenseApplicationLines) Get() *ExpenseApplicationUpdateParamsExpenseApplicationLines {
	return v.value
}

func (v *NullableExpenseApplicationUpdateParamsExpenseApplicationLines) Set(val *ExpenseApplicationUpdateParamsExpenseApplicationLines) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseApplicationUpdateParamsExpenseApplicationLines) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseApplicationUpdateParamsExpenseApplicationLines) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseApplicationUpdateParamsExpenseApplicationLines(val *ExpenseApplicationUpdateParamsExpenseApplicationLines) *NullableExpenseApplicationUpdateParamsExpenseApplicationLines {
	return &NullableExpenseApplicationUpdateParamsExpenseApplicationLines{value: val, isSet: true}
}

func (v NullableExpenseApplicationUpdateParamsExpenseApplicationLines) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseApplicationUpdateParamsExpenseApplicationLines) UnmarshalJSON(src []byte) error {
	v.isSet = true
