...
// TaxResponseTax struct for TaxResponseTax
type TaxResponseTax struct {
	// 税区分コード
...
func (o TaxResponseTax) MarshalJSON() ([]byte, error) {
...
type NullableTaxResponseTax struct {
	value *TaxResponseTax
	isSet bool
}

func (v NullableTaxResponseTax) Get() *TaxResponseTax {
	return v.value
}

func (v *NullableTaxResponseTax) Set(val *TaxResponseTax) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxResponseTax) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxResponseTax) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxResponseTax(val *TaxResponseTax) *NullableTaxResponseTax {
	return &NullableTaxResponseTax{value: val, isSet: true}
}

func (v NullableTaxResponseTax) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxResponseTax) UnmarshalJSON(src []byte) error {
	v.isSet = true
