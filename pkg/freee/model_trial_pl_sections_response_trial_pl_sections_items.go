...
// TrialPlSectionsResponseTrialPlSectionsItems struct for TrialPlSectionsResponseTrialPlSectionsItems
type TrialPlSectionsResponseTrialPlSectionsItems struct {
	// 品目ID
	Id int32 `json:"id"`
	// 品目
...
func NewTrialPlSectionsResponseTrialPlSectionsItems(id int32, ) *TrialPlSectionsResponseTrialPlSectionsItems {
	this := TrialPlSectionsResponseTrialPlSectionsItems{}
	this.Id = id
	return &this
}
...
func (o TrialPlSectionsResponseTrialPlSectionsItems) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlSectionsResponseTrialPlSectionsItems struct {
	value *TrialPlSectionsResponseTrialPlSectionsItems
	isSet bool
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsItems) Get() *TrialPlSectionsResponseTrialPlSectionsItems {
	return v.value
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsItems) Set(val *TrialPlSectionsResponseTrialPlSectionsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlSectionsResponseTrialPlSectionsItems(val *TrialPlSectionsResponseTrialPlSectionsItems) *NullableTrialPlSectionsResponseTrialPlSectionsItems {
	return &NullableTrialPlSectionsResponseTrialPlSectionsItems{value: val, isSet: true}
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
