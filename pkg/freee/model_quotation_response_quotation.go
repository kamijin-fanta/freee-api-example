...
type QuotationResponseQuotation struct {
	...
	// 関連する請求書ID<br> 下記で作成したものが該当します。  <a href=\"https://support.freee.co.jp/hc/ja/articles/203318410-請求書-納品書-見積書を作成する%231-2#1-2\" target=\"_blank\">見積書・納品書を納品書・請求書に変換する</a><br> <a href=\"https://support.freee.co.jp/hc/ja/articles/209076226\" target=\"_blank\">複数の見積書・納品書から合算請求書を作成する</a><br> 
...
func (o *QuotationResponseQuotation) SetPartnerCodeNil() {
...
func (o *QuotationResponseQuotation) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *QuotationResponseQuotation) SetDescriptionNil() {
...
func (o *QuotationResponseQuotation) SetWebPublishedAtNil() {
...
func (o *QuotationResponseQuotation) SetWebDownloadedAtNil() {
...
func (o *QuotationResponseQuotation) SetWebConfirmedAtNil() {
...
func (o *QuotationResponseQuotation) SetMailSentAtNil() {
...
func (o *QuotationResponseQuotation) SetPartnerNameNil() {
...
func (o *QuotationResponseQuotation) SetPartnerDisplayNameNil() {
...
func (o *QuotationResponseQuotation) SetPartnerZipcodeNil() {
...
func (o *QuotationResponseQuotation) SetPartnerPrefectureCodeNil() {
...
func (o *QuotationResponseQuotation) SetPartnerPrefectureNameNil() {
...
func (o *QuotationResponseQuotation) SetPartnerAddress1Nil() {
...
func (o *QuotationResponseQuotation) SetPartnerAddress2Nil() {
...
func (o *QuotationResponseQuotation) SetPartnerContactInfoNil() {
...
func (o *QuotationResponseQuotation) SetCompanyZipcodeNil() {
...
func (o *QuotationResponseQuotation) SetCompanyPrefectureCodeNil() {
...
func (o *QuotationResponseQuotation) SetCompanyPrefectureNameNil() {
...
func (o *QuotationResponseQuotation) SetCompanyAddress1Nil() {
...
func (o *QuotationResponseQuotation) SetCompanyAddress2Nil() {
...
func (o *QuotationResponseQuotation) SetCompanyContactInfoNil() {
...
func (o *QuotationResponseQuotation) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *QuotationResponseQuotation) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *QuotationResponseQuotation) SetRelatedInvoiceIdNil() {
...
func (o QuotationResponseQuotation) MarshalJSON() ([]byte, error) {
	...
	if o.RelatedInvoiceId.IsSet() {
		toSerialize["related_invoice_id"] = o.RelatedInvoiceId.Get()
	}
...
type NullableQuotationResponseQuotation struct {
	value *QuotationResponseQuotation
	isSet bool
}

func (v NullableQuotationResponseQuotation) Get() *QuotationResponseQuotation {
	return v.value
}

func (v *NullableQuotationResponseQuotation) Set(val *QuotationResponseQuotation) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationResponseQuotation) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationResponseQuotation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationResponseQuotation(val *QuotationResponseQuotation) *NullableQuotationResponseQuotation {
	return &NullableQuotationResponseQuotation{value: val, isSet: true}
}

func (v NullableQuotationResponseQuotation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationResponseQuotation) UnmarshalJSON(src []byte) error {
	v.isSet = true
