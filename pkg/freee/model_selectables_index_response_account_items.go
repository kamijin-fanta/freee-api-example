...
func NewSelectablesIndexResponseAccountItems(id int32, ) *SelectablesIndexResponseAccountItems {
	this := SelectablesIndexResponseAccountItems{}
	this.Id = id
	return &this
}
...
func (o *SelectablesIndexResponseAccountItems) GetDefaultTax() SelectablesIndexResponseDefaultTax {
	if o == nil || o.DefaultTax == nil {
		var ret SelectablesIndexResponseDefaultTax
		return ret
	}
	return *o.DefaultTax
}
...
// SetDefaultTax gets a reference to the given SelectablesIndexResponseDefaultTax and assigns it to the DefaultTax field.
func (o *SelectablesIndexResponseAccountItems) SetDefaultTax(v SelectablesIndexResponseDefaultTax) {
	o.DefaultTax = &v
}

func (o SelectablesIndexResponseAccountItems) MarshalJSON() ([]byte, error) {
...
type NullableSelectablesIndexResponseAccountItems struct {
	value *SelectablesIndexResponseAccountItems
	isSet bool
}

func (v NullableSelectablesIndexResponseAccountItems) Get() *SelectablesIndexResponseAccountItems {
	return v.value
}

func (v *NullableSelectablesIndexResponseAccountItems) Set(val *SelectablesIndexResponseAccountItems) {
	v.value = val
	v.isSet = true
}

func (v NullableSelectablesIndexResponseAccountItems) IsSet() bool {
	return v.isSet
}

func (v *NullableSelectablesIndexResponseAccountItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSelectablesIndexResponseAccountItems(val *SelectablesIndexResponseAccountItems) *NullableSelectablesIndexResponseAccountItems {
	return &NullableSelectablesIndexResponseAccountItems{value: val, isSet: true}
}

func (v NullableSelectablesIndexResponseAccountItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSelectablesIndexResponseAccountItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
