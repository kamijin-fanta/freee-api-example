...
func (o CompaniesPlanResponse) MarshalJSON() ([]byte, error) {
...
type NullableCompaniesPlanResponse struct {
	value *CompaniesPlanResponse
	isSet bool
}

func (v NullableCompaniesPlanResponse) Get() *CompaniesPlanResponse {
	return v.value
}

func (v *NullableCompaniesPlanResponse) Set(val *CompaniesPlanResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCompaniesPlanResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCompaniesPlanResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompaniesPlanResponse(val *CompaniesPlanResponse) *NullableCompaniesPlanResponse {
	return &NullableCompaniesPlanResponse{value: val, isSet: true}
}

func (v NullableCompaniesPlanResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompaniesPlanResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
