...
func (o ReceiptUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableReceiptUpdateParams struct {
	value *ReceiptUpdateParams
	isSet bool
}

func (v NullableReceiptUpdateParams) Get() *ReceiptUpdateParams {
	return v.value
}

func (v *NullableReceiptUpdateParams) Set(val *ReceiptUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableReceiptUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableReceiptUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReceiptUpdateParams(val *ReceiptUpdateParams) *NullableReceiptUpdateParams {
	return &NullableReceiptUpdateParams{value: val, isSet: true}
}

func (v NullableReceiptUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReceiptUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
