 ...
 */
func (a *PaymentsApiService) DestroyDealPayment(ctx _context.Context, id int32, paymentId int32) ApiDestroyDealPaymentRequest {
	return ApiDestroyDealPaymentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 */
func (a *PaymentsApiService) UpdateDealPayment(ctx _context.Context, id int32, paymentId int32) ApiUpdateDealPaymentRequest {
	return ApiUpdateDealPaymentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
