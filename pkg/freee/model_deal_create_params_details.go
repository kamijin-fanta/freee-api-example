...
func (o DealCreateParamsDetails) MarshalJSON() ([]byte, error) {
...
type NullableDealCreateParamsDetails struct {
	value *DealCreateParamsDetails
	isSet bool
}

func (v NullableDealCreateParamsDetails) Get() *DealCreateParamsDetails {
	return v.value
}

func (v *NullableDealCreateParamsDetails) Set(val *DealCreateParamsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDealCreateParamsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDealCreateParamsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealCreateParamsDetails(val *DealCreateParamsDetails) *NullableDealCreateParamsDetails {
	return &NullableDealCreateParamsDetails{value: val, isSet: true}
}

func (v NullableDealCreateParamsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealCreateParamsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
