...
func NewDeprecatedApprovalRequestResponseApprovalRequest(id int32, companyId int32, applicationDate string, title string, applicantId int32, approverId NullableInt32, applicationNumber string, status string, requestItems []DeprecatedApprovalRequestResponseApprovalRequestRequestItems, ) *DeprecatedApprovalRequestResponseApprovalRequest {
	this := DeprecatedApprovalRequestResponseApprovalRequest{}
	this.Id = id
...
func (o *DeprecatedApprovalRequestResponseApprovalRequest) GetRequestItems() []DeprecatedApprovalRequestResponseApprovalRequestRequestItems {
	if o == nil  {
		var ret []DeprecatedApprovalRequestResponseApprovalRequestRequestItems
		return ret
	}
...
func (o DeprecatedApprovalRequestResponseApprovalRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeprecatedApprovalRequestResponseApprovalRequest struct {
	value *DeprecatedApprovalRequestResponseApprovalRequest
	isSet bool
}

func (v NullableDeprecatedApprovalRequestResponseApprovalRequest) Get() *DeprecatedApprovalRequestResponseApprovalRequest {
	return v.value
}

func (v *NullableDeprecatedApprovalRequestResponseApprovalRequest) Set(val *DeprecatedApprovalRequestResponseApprovalRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeprecatedApprovalRequestResponseApprovalRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeprecatedApprovalRequestResponseApprovalRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeprecatedApprovalRequestResponseApprovalRequest(val *DeprecatedApprovalRequestResponseApprovalRequest) *NullableDeprecatedApprovalRequestResponseApprovalRequest {
	return &NullableDeprecatedApprovalRequestResponseApprovalRequest{value: val, isSet: true}
}

func (v NullableDeprecatedApprovalRequestResponseApprovalRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeprecatedApprovalRequestResponseApprovalRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
