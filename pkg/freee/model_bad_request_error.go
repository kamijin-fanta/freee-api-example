...
type BadRequestError struct {
	...
	Errors *[]BadRequestErrorErrors `json:"errors,omitempty"`
}
...
// SetErrors gets a reference to the given []BadRequestErrorErrors and assigns it to the Errors field.
