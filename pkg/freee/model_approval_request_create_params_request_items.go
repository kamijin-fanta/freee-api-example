...
// ApprovalRequestCreateParamsRequestItems struct for ApprovalRequestCreateParamsRequestItems
type ApprovalRequestCreateParamsRequestItems struct {
	// 項目ID
...
func NewApprovalRequestCreateParamsRequestItems() *ApprovalRequestCreateParamsRequestItems {
	this := ApprovalRequestCreateParamsRequestItems{}
	return &this
}
...
func (o ApprovalRequestCreateParamsRequestItems) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestCreateParamsRequestItems struct {
	value *ApprovalRequestCreateParamsRequestItems
	isSet bool
}

func (v NullableApprovalRequestCreateParamsRequestItems) Get() *ApprovalRequestCreateParamsRequestItems {
	return v.value
}

func (v *NullableApprovalRequestCreateParamsRequestItems) Set(val *ApprovalRequestCreateParamsRequestItems) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestCreateParamsRequestItems) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestCreateParamsRequestItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestCreateParamsRequestItems(val *ApprovalRequestCreateParamsRequestItems) *NullableApprovalRequestCreateParamsRequestItems {
	return &NullableApprovalRequestCreateParamsRequestItems{value: val, isSet: true}
}

func (v NullableApprovalRequestCreateParamsRequestItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestCreateParamsRequestItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
