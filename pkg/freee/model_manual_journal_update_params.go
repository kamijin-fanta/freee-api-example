...
// ManualJournalUpdateParams struct for ManualJournalUpdateParams
type ManualJournalUpdateParams struct {
	// 事業所ID
	...
	Details []ManualJournalUpdateParamsDetails `json:"details"`
}
...
func (o *ManualJournalUpdateParams) GetDetails() []ManualJournalUpdateParamsDetails {
	if o == nil  {
		var ret []ManualJournalUpdateParamsDetails
		return ret
	}
...
func (o ManualJournalUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalUpdateParams struct {
	value *ManualJournalUpdateParams
	isSet bool
}

func (v NullableManualJournalUpdateParams) Get() *ManualJournalUpdateParams {
	return v.value
}

func (v *NullableManualJournalUpdateParams) Set(val *ManualJournalUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalUpdateParams(val *ManualJournalUpdateParams) *NullableManualJournalUpdateParams {
	return &NullableManualJournalUpdateParams{value: val, isSet: true}
}

func (v NullableManualJournalUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
