...
// MeResponseUserCompanies struct for MeResponseUserCompanies
type MeResponseUserCompanies struct {
	// 事業所ID
	Id int32 `json:"id"`
	// 表示名
...
// GetUseCustomRole returns the UseCustomRole field value
func (o *MeResponseUserCompanies) GetUseCustomRole() bool {
	...
	return o.UseCustomRole
}

// GetUseCustomRoleOk returns a tuple with the UseCustomRole field value
// and a boolean to check if the value has been set.
func (o *MeResponseUserCompanies) GetUseCustomRoleOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.UseCustomRole, true
}

// SetUseCustomRole sets field value
func (o *MeResponseUserCompanies) SetUseCustomRole(v bool) {
	o.UseCustomRole = v
}

func (o MeResponseUserCompanies) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["use_custom_role"] = o.UseCustomRole
	}
	return json.Marshal(toSerialize)
}

type NullableMeResponseUserCompanies struct {
	value *MeResponseUserCompanies
	isSet bool
}

func (v NullableMeResponseUserCompanies) Get() *MeResponseUserCompanies {
	return v.value
}

func (v *NullableMeResponseUserCompanies) Set(val *MeResponseUserCompanies) {
	v.value = val
	v.isSet = true
}

func (v NullableMeResponseUserCompanies) IsSet() bool {
	return v.isSet
}

func (v *NullableMeResponseUserCompanies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeResponseUserCompanies(val *MeResponseUserCompanies) *NullableMeResponseUserCompanies {
	return &NullableMeResponseUserCompanies{value: val, isSet: true}
}

func (v NullableMeResponseUserCompanies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeResponseUserCompanies) UnmarshalJSON(src []byte) error {
	v.isSet = true
