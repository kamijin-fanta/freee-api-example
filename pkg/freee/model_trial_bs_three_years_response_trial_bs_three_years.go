...
func (o TrialBsThreeYearsResponseTrialBsThreeYears) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsThreeYearsResponseTrialBsThreeYears struct {
	value *TrialBsThreeYearsResponseTrialBsThreeYears
	isSet bool
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYears) Get() *TrialBsThreeYearsResponseTrialBsThreeYears {
	return v.value
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYears) Set(val *TrialBsThreeYearsResponseTrialBsThreeYears) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYears) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYears) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsThreeYearsResponseTrialBsThreeYears(val *TrialBsThreeYearsResponseTrialBsThreeYears) *NullableTrialBsThreeYearsResponseTrialBsThreeYears {
	return &NullableTrialBsThreeYearsResponseTrialBsThreeYears{value: val, isSet: true}
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYears) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYears) UnmarshalJSON(src []byte) error {
	v.isSet = true
