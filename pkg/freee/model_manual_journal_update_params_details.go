...
func NewManualJournalUpdateParamsDetails(entrySide string, taxCode int32, accountItemId int32, amount int32, ) *ManualJournalUpdateParamsDetails {
	this := ManualJournalUpdateParamsDetails{}
...
func (o ManualJournalUpdateParamsDetails) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalUpdateParamsDetails struct {
	value *ManualJournalUpdateParamsDetails
	isSet bool
}

func (v NullableManualJournalUpdateParamsDetails) Get() *ManualJournalUpdateParamsDetails {
	return v.value
}

func (v *NullableManualJournalUpdateParamsDetails) Set(val *ManualJournalUpdateParamsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalUpdateParamsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalUpdateParamsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalUpdateParamsDetails(val *ManualJournalUpdateParamsDetails) *NullableManualJournalUpdateParamsDetails {
	return &NullableManualJournalUpdateParamsDetails{value: val, isSet: true}
}

func (v NullableManualJournalUpdateParamsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalUpdateParamsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
