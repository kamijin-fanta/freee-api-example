...
// GetUsePartnerCode returns the UsePartnerCode field value
...
// GetFiscalYears returns the FiscalYears field value
...
type NullableCompanyResponseCompany struct {
	value *CompanyResponseCompany
	isSet bool
}

func (v NullableCompanyResponseCompany) Get() *CompanyResponseCompany {
	return v.value
}

func (v *NullableCompanyResponseCompany) Set(val *CompanyResponseCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseCompany(val *CompanyResponseCompany) *NullableCompanyResponseCompany {
	return &NullableCompanyResponseCompany{value: val, isSet: true}
}

func (v NullableCompanyResponseCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
