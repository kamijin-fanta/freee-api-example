...
func NewInvoiceCreateParamsInvoiceContents(order int32, type_ string, ) *InvoiceCreateParamsInvoiceContents {
	this := InvoiceCreateParamsInvoiceContents{}
	this.Order = order
	this.Type = type_
	return &this
}
...
func (o *InvoiceCreateParamsInvoiceContents) SetVatNil() {
	o.Vat.Set(nil)
}
...
func (o InvoiceCreateParamsInvoiceContents) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceCreateParamsInvoiceContents struct {
	value *InvoiceCreateParamsInvoiceContents
	isSet bool
}

func (v NullableInvoiceCreateParamsInvoiceContents) Get() *InvoiceCreateParamsInvoiceContents {
	return v.value
}

func (v *NullableInvoiceCreateParamsInvoiceContents) Set(val *InvoiceCreateParamsInvoiceContents) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceCreateParamsInvoiceContents) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceCreateParamsInvoiceContents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceCreateParamsInvoiceContents(val *InvoiceCreateParamsInvoiceContents) *NullableInvoiceCreateParamsInvoiceContents {
	return &NullableInvoiceCreateParamsInvoiceContents{value: val, isSet: true}
}

func (v NullableInvoiceCreateParamsInvoiceContents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceCreateParamsInvoiceContents) UnmarshalJSON(src []byte) error {
	v.isSet = true
