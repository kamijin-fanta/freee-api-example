...
func NewSelectablesIndexResponseAccountCategories(balance string, orgCode string, role string, title string, accountItems []SelectablesIndexResponseAccountItems, ) *SelectablesIndexResponseAccountCategories {
	this := SelectablesIndexResponseAccountCategories{}
...
func (o *SelectablesIndexResponseAccountCategories) GetAccountItems() []SelectablesIndexResponseAccountItems {
	if o == nil  {
		var ret []SelectablesIndexResponseAccountItems
		return ret
	}
...
func (o SelectablesIndexResponseAccountCategories) MarshalJSON() ([]byte, error) {
...
type NullableSelectablesIndexResponseAccountCategories struct {
	value *SelectablesIndexResponseAccountCategories
	isSet bool
}

func (v NullableSelectablesIndexResponseAccountCategories) Get() *SelectablesIndexResponseAccountCategories {
	return v.value
}

func (v *NullableSelectablesIndexResponseAccountCategories) Set(val *SelectablesIndexResponseAccountCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableSelectablesIndexResponseAccountCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableSelectablesIndexResponseAccountCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSelectablesIndexResponseAccountCategories(val *SelectablesIndexResponseAccountCategories) *NullableSelectablesIndexResponseAccountCategories {
	return &NullableSelectablesIndexResponseAccountCategories{value: val, isSet: true}
}

func (v NullableSelectablesIndexResponseAccountCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSelectablesIndexResponseAccountCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
