...
// TrialPlSectionsResponseTrialPlSectionsSections struct for TrialPlSectionsResponseTrialPlSectionsSections
type TrialPlSectionsResponseTrialPlSectionsSections struct {
	// 部門ID
	Id int32 `json:"id"`
	// 部門名
	...
	Partners *[]TrialPlSectionsResponseTrialPlSectionsPartners `json:"partners,omitempty"`
	// breakdown_display_type:item, account_item_display_type:account_item指定時のみ含まれる
	Items *[]TrialPlSectionsResponseTrialPlSectionsItems `json:"items,omitempty"`
}
...
func NewTrialPlSectionsResponseTrialPlSectionsSections(id int32, ) *TrialPlSectionsResponseTrialPlSectionsSections {
	this := TrialPlSectionsResponseTrialPlSectionsSections{}
	this.Id = id
	return &this
}
...
func (o *TrialPlSectionsResponseTrialPlSectionsSections) GetPartners() []TrialPlSectionsResponseTrialPlSectionsPartners {
	if o == nil || o.Partners == nil {
		var ret []TrialPlSectionsResponseTrialPlSectionsPartners
		return ret
	}
	return *o.Partners
}
...
// SetPartners gets a reference to the given []TrialPlSectionsResponseTrialPlSectionsPartners and assigns it to the Partners field.
...
func (o *TrialPlSectionsResponseTrialPlSectionsSections) GetItems() []TrialPlSectionsResponseTrialPlSectionsItems {
	if o == nil || o.Items == nil {
		var ret []TrialPlSectionsResponseTrialPlSectionsItems
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []TrialPlSectionsResponseTrialPlSectionsItems and assigns it to the Items field.
func (o *TrialPlSectionsResponseTrialPlSectionsSections) SetItems(v []TrialPlSectionsResponseTrialPlSectionsItems) {
	o.Items = &v
}

func (o TrialPlSectionsResponseTrialPlSectionsSections) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlSectionsResponseTrialPlSectionsSections struct {
	value *TrialPlSectionsResponseTrialPlSectionsSections
	isSet bool
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsSections) Get() *TrialPlSectionsResponseTrialPlSectionsSections {
	return v.value
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsSections) Set(val *TrialPlSectionsResponseTrialPlSectionsSections) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsSections) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsSections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlSectionsResponseTrialPlSectionsSections(val *TrialPlSectionsResponseTrialPlSectionsSections) *NullableTrialPlSectionsResponseTrialPlSectionsSections {
	return &NullableTrialPlSectionsResponseTrialPlSectionsSections{value: val, isSet: true}
}

func (v NullableTrialPlSectionsResponseTrialPlSectionsSections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlSectionsResponseTrialPlSectionsSections) UnmarshalJSON(src []byte) error {
	v.isSet = true
