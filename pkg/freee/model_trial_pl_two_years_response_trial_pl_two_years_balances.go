...
func NewTrialPlTwoYearsResponseTrialPlTwoYearsBalances() *TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
	this := TrialPlTwoYearsResponseTrialPlTwoYearsBalances{}
	return &this
}
...
func (o *TrialPlTwoYearsResponseTrialPlTwoYearsBalances) GetSections() []TrialPlTwoYearsResponseTrialPlTwoYearsSections {
	if o == nil || o.Sections == nil {
		var ret []TrialPlTwoYearsResponseTrialPlTwoYearsSections
		return ret
	}
	return *o.Sections
}
...
// SetSections gets a reference to the given []TrialPlTwoYearsResponseTrialPlTwoYearsSections and assigns it to the Sections field.
...
func (o TrialPlTwoYearsResponseTrialPlTwoYearsBalances) MarshalJSON() ([]byte, error) {
...
type NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances struct {
	value *TrialPlTwoYearsResponseTrialPlTwoYearsBalances
	isSet bool
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) Get() *TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
	return v.value
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) Set(val *TrialPlTwoYearsResponseTrialPlTwoYearsBalances) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances(val *TrialPlTwoYearsResponseTrialPlTwoYearsBalances) *NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances {
	return &NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances{value: val, isSet: true}
}

func (v NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlTwoYearsResponseTrialPlTwoYearsBalances) UnmarshalJSON(src []byte) error {
	v.isSet = true
