...
// TrialBsTwoYearsResponseTrialBsTwoYearsPartners struct for TrialBsTwoYearsResponseTrialBsTwoYearsPartners
type TrialBsTwoYearsResponseTrialBsTwoYearsPartners struct {
	// 取引先ID
	Id int32 `json:"id"`
	// 取引先名
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsPartners(id int32, ) *TrialBsTwoYearsResponseTrialBsTwoYearsPartners {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsPartners{}
	this.Id = id
	return &this
}
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsPartners) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsPartners
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsPartners {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners(val *TrialBsTwoYearsResponseTrialBsTwoYearsPartners) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsPartners) UnmarshalJSON(src []byte) error {
	v.isSet = true
